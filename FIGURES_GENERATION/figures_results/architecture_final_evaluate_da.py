...
def main():
    ...
    model_path = "./tmp/best_model_da.pth"
    ...
    df.to_csv("./tmp/cherry_picked_g_s_g_u_total_da_no_adapter.csv", index=False)
    ...
    df.to_csv("./tmp/cherry_picked_g_s_g_u_da_no_adapter.csv", index=False)
    ...
    if True:
        ...
        for nl in noise_levels:
            ...
            # save the dataframe
            df.to_csv(f"./tmp/cherry_picked_g_s_g_u_nl_{nl}_da_no_adapter.csv", index=False)
