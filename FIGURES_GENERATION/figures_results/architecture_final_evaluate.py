...
def main():
    ...
    model_path = "./tmp/best_model_new3.pth"
    ...
    # SETUP DATASET
    test_set = SpikeTrainDataset(data_path="./tmp/test_set_stg.csv", noise_level=0, should_log=config.should_log, frac=config.fraction_of_data, cherry_pick=False)
